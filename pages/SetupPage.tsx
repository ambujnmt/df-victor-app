...
<script>
  ...
  return (
    <div className="min-h-screen bg-hey-church-bg flex items-center justify-center p-4 py-20 overflow-y-auto">
      <div className="max-w-2xl w-full bg-gray-800 rounded-xl shadow-2xl p-8 space-y-6">
        <div className="text-center">
          <div className="inline-block bg-hey-church-green p-4 rounded-full mb-4">
        ...
        {renderErrorMessage()}
         ...
         <div className="space-y-4 text-sm text-gray-300 bg-gray-900/50 p-4 rounded-lg">
            <p className="font-bold text-base text-hey-church-yellow">1. Apply Your Configuration</p>
        ...
        <div className="space-y-4 text-sm text-gray-300 bg-gray-900/50 p-4 rounded-lg">
            <p className="font-bold text-base text-hey-church-yellow flex items-center">
            ...
            <ul className="space-y-4 mt-2">
                 <li className="flex items-start">
                    <span className="font-bold text-hey-church-orange-400 mr-2 text-lg">A.</span>
                    <div>
                        ...
                        <code className="mt-2 block bg-black/40 p-2 rounded text-hey-church-blue font-mono text-[10px] break-all">
                            {window.location.hostname}
                        </code>
                    </div>
                </li>
                <li className="flex items-start">
                    <span className="font-bold text-hey-church-orange-400 mr-2 text-lg">B.</span>
                    <div>
                 ...
                 <li className="flex items-start">
                    <span className="font-bold text-hey-church-orange-400 mr-2 text-lg">C.</span>
                    <div>
