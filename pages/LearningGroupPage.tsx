...
const LearningGroupPage: React.FC = () => {
    ...
    const renderLesson = (lesson: any, index: number) => {
        if (lesson.type === 'internal') {
            ...
            return (
                ...
                >
                    <div className="mr-4">
                        {isCompleted ? <CheckCircle className="text-green-500" size={24} /> : <PlayCircle className="text-hey-church-orange-400" size={24} />}
                    </div>
        ...
        if (lesson.type === 'external') {
            return (
                <a 
                    ...
                    className="flex items-center p-3 bg-gray-700 rounded-md hover:bg-gray-600 transition-colors"
                >
                    <div className="mr-4"><ExternalLink className="text-hey-church-orange-400" size={24} /></div>
                    <div className="flex-grow">
                        <p className="font-bold text-white">{`Step ${index + 1}: ${lesson.title}`}</p>
    ...
    return (
        <div className="p-4 space-y-6 bg-hey-church-bg min-h-screen text-white">
            <div>
                 <button onClick={() => navigate('/academy')} className="text-hey-church-orange-400 mb-4">&larr; Back to Academy</button>
            ...
            <div className="bg-gray-800 p-4 rounded-lg shadow-lg">
                ...
                <div className="space-y-4 max-h-96 overflow-y-auto pr-2">
                 ...
                 <div className="mt-4 flex space-x-2">
                    ...
                    />
                    <button onClick={handlePostMessage} className="bg-hey-church-red p-3 rounded-lg text-white">
                        <Send size={20}/>
                    </button>
                </div>
            </div>
