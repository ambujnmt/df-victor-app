        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto">
            <div className="max-w-2xl w-full">
                ...
                >
                    ...
                    {/* Corner Ornaments */}
                    <div className="absolute top-4 left-4 w-16 h-16 border-t-2 border-l-2 border-hey-church-yellow/40"></div>
                    <div className="absolute top-4 right-4 w-16 h-16 border-t-2 border-r-2 border-hey-church-yellow/40"></div>
                    <div className="absolute bottom-4 left-4 w-16 h-16 border-b-2 border-l-2 border-hey-church-yellow/40"></div>
                    <div className="absolute bottom-4 right-4 w-16 h-16 border-b-2 border-r-2 border-hey-church-yellow/40"></div>

                    <div className="relative z-10 space-y-6">
                        <div className="flex justify-center mb-2">
                             <div className="bg-hey-church-yellow p-4 rounded-full shadow-[0_0_30px_rgba(251,191,36,0.4)]">
                                <Award size={48} className="text-hey-church-bg" />
                             </div>
                        </div>
                        
                        <h1 className="text-hey-church-yellow font-black uppercase tracking-[0.3em] text-sm">Certificate of Completion</h1>
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-[10px] font-bold text-hey-church-blue uppercase tracking-widest">{certificate.pathId.replace('_', ' ')} Path</p>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 w-full flex justify-between items-end pt-8">
                        ...
                        <div className="text-center">
                            <div className="w-16 h-16 rounded-full border-2 border-hey-church-yellow/30 flex items-center justify-center opacity-40">
                                <CheckCircle size={32} className="text-hey-church-yellow" />
                            </div>
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                    <button 
                        ...
                        className="bg-white text-hey-church-bg font-black py-4 rounded-2xl flex items-center justify-center hover:bg-gray-100 transition-all active:scale-95"
                    >
