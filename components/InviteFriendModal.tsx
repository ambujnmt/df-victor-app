                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex space-x-2">
                             <input 
                                ...
                                className="flex-grow p-4 bg-gray-900 border border-gray-700 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:border-hey-church-red transition-all"
                            />
                            <button onClick={handleSendDirectInvitation} disabled={status === 'sending'} className="bg-hey-church-red text-white font-black p-4 rounded-2xl hover:brightness-110 flex items-center justify-center transition-all active:scale-95 disabled:bg-gray-600">
