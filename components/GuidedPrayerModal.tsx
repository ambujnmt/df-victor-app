            ...
            <div className="w-full h-full flex flex-col relative z-10 max-w-lg mx-auto">
                {!hasStarted && (
                    <div className="flex flex-col items-center justify-center h-full space-y-12 p-8 animate-in zoom-in duration-500">
                        <div className="text-center">
                            ...
                            <p className="text-white/70 font-bold tracking-[0.3em] text-[10px] uppercase">A Moment of Peace</p>
                        </div>
                ...
                {hasStarted && !hasAmened && (
                    <div className="w-full h-full flex flex-col p-8">
                        <div className="text-center pt-12 pb-8">
                            <span className="bg-hey-church-yellow text-black px-5 py-1.5 rounded-full text-[10px] font-black uppercase tracking-[0.2em] shadow-lg">Guided Prayer</span>
                        </div>
                        ...
                        <div className="flex-grow flex flex-col items-center justify-center w-full relative">
                            {!isFinished ? (
                                ...
                                <div className="animate-in fade-in zoom-in duration-500 flex flex-col items-center">
                                    <button onClick={handleAmen} className="bg-gradient-to-r from-hey-church-yellow to-[#EF6D4D] text-black text-6xl font-black py-12 px-24 rounded-full hover:scale-110 transition-transform shadow-[0_0_60px_rgba(251,191,36,0.6)]">
                                        AMEN
                                    </button>
                        ...
                        {!isFinished && (
                            <div className="flex flex-col items-center pb-16 space-y-8">
                                ...
                                <button onClick={cycleTrack} className="flex items-center space-x-3 bg-black/30 backdrop-blur-md px-6 py-3 rounded-full border border-white/10 hover:bg-black/50 transition-all group">
                                    <Music size={16} className="text-hey-church-yellow group-hover:animate-bounce"/><span className="text-[10px] font-black text-white uppercase tracking-[0.2em]">{BACKGROUND_TRACKS[activeTrackIndex].name}</span>
                                </button>
                            </div>
                        )}
                        ...
                        {!isFinished && (
                            <div className="absolute bottom-0 left-0 h-2 bg-white/5 w-full">
                                <div className="h-full bg-hey-church-yellow shadow-[0_0_15px_#FBBF24] transition-all duration-[5500ms] ease-linear" style={{ width: `${((currentLineIndex + 1) / PRAYER_LINES.length) * 100}%` }}></div>
                            </div>
                        )}
                    </div>
                )}
                ...
                {hasAmened && (
                    <div className="w-full h-full flex flex-col items-center justify-center p-6 animate-in fade-in slide-in-from-bottom-10 duration-1000">
                        <div className="bg-hey-church-yellow text-black font-black px-6 py-2 rounded-full mb-8 text-[10px] uppercase tracking-widest animate-bounce shadow-xl">
                            +50 Points Earned
                        </div>
                        ...
                        <div ref={prayerCardRef} className="w-full max-w-[340px] prayer-card-brilliant rounded-[2.5rem] p-8 pb-6 shadow-[0_40px_120px_rgba(0,0,0,0.8)] border border-white/10 relative overflow-hidden flex flex-col">
                            ...
                            <div className="flex items-stretch mb-6">
                                <div className="w-1.5 bg-hey-church-yellow rounded-full mr-4 shadow-[0_0_15px_rgba(251,191,36,0.6)]"></div>
                                <h3 className="text-hey-church-yellow font-black uppercase text-xl leading-none tracking-tight">
                                    {t(snack.titleKey)}
                                </h3>
                            </div>
