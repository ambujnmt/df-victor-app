                ...
                <button onClick={onToggleNotifications} className="relative text-gray-300 hover:text-white">
                    ...
                    {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 flex h-4 w-4">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-hey-church-red opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-4 w-4 bg-hey-church-red text-xs items-center justify-center">{unreadCount}</span>
                        </span>
                    )}
                </button>
            </div>
